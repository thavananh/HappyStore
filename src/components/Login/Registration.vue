...
async function register() {
    try {
        const response = await axios.post('/api/customer_account/create', {
        ...
        <div class="col-lg-8 col-xl-5 offset-xl-1">
            <form @submit="handleSubmit">
                ...
                <div class="row">
                    <!-- Email -->
                    <div class="col-md-6 mb-3">
                        <label for="email" class="form-label fs-5" style="color: black"
                            >Email</label
                        >
                ...
                <div class="mb-3">
                    <label for="inputPhoneNumber" class="form-label fs-5" style="color: black;">Phone Number</label>
                    <input type="password" class="form-control" id="inputPassword" required>
                    <div class="invalid-feedback">This field is required.</div>
                </div>
                <!-- Row 3 -->
                <div class="mb-3">
                    <label for="inputPassword" class="form-label fs-5" style="color: black;">Password</label>
                    <input type="password" class="form-control" id="inputPassword" required>
                    <div class="invalid-feedback">This field is required.</div>
                </div>
                ...
                <!-- Confirm Password -->
                <div class="mb-3">
                    <label for="confirmPassword" class="form-label fs-5" style="color: black;">Confirm Password</label>
